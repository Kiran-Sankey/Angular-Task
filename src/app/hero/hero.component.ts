...
export class HeroComponent implements OnInit {
  ...
  constructor(private supdata: FetchdataService, private utcDate: DatePipe, private route: Router) { }
  ...
  ngOnInit(): void {
    this.supdata.fetchData().subscribe(response => {
      ...
      if (response) {
        ...
        this.displayImages = this.dataToDisplay.imagesInfo;
        this.primaryPacking = this.dataToDisplay.primarypkg;
        this.secondarypkg = this.dataToDisplay.secondarypkg;
        this.approvalInform = this.dataToDisplay.approvalInfo;
    ...
    console.log("approval info is : ", this.approvalInform.names);
  }
